...
(function () {
  ...
  const defaultCategoryColors=['#00843d','#7042d4','#9a7200','#165bdf'];
  ...
  function organizeSettings(){
    ...
    const sections=[['profile','Profile'],['appearance','Appearance'],['account','Your account & data'],['guide','How to use']];if(!demo)sections.push(['sharing','Sharing']);
  ...
  function showTour(){
    const [nextPage,nextView,title,body]=tourSteps[tourIndex];page=nextPage;if(nextView)view=nextView;if(page==='settings')settingsSection=tourIndex===7?'account':'appearance';render();
  ...
  const tourTargets=['.bd-heading','.bd-month','#bd-fab','.bd-timeline','.bd-week-mobile,.bd-week-grid','.bd-note-grid','.bd-stats','#bd-account-card','#bd-settings'];
