...
(function () {
  ...
  function appGuide() {
    return `<section class="bd-card bd-guide" id="bd-app-guide"><h2>How to use app</h2><p>A short, guided walk through planning, moving blocks, Brainstorm, Insights, and saving. It opens each feature and shows you where to look. Nothing in your schedule is changed.</p><button class="bd-primary" data-action="tour">Start app tour →</button><p>You can replay it here whenever you like.</p><div class="bd-guide-tips"><h2>Tips on timeblocking</h2>${timeblockingTips()}</div></section>`;
  }
  function timeblockingTips(){return `<div class="bd-tips-grid"><article><span>BEDO’S RHYTHM</span><h3>Plan, adjust, notice.</h3><p>Schedule your week before it starts. Readjust tomorrow the night before, then tick blocks around midday and before bed. The goal is awareness—not a perfect plan—so time can feel like yours again.</p></article><article><span>MAKE THE WHEN SPECIFIC</span><h3>Turn intention into time.</h3><p>Give an important action a concrete time and situation. Research on implementation intentions finds that specific “when and how” plans improve goal attainment.</p><a href="https://doi.org/10.1016/S0065-2601(06)38002-1" target="_blank" rel="noopener">Gollwitzer & Sheeran meta-analysis ↗</a></article><article><span>PLAN FOR REAL LIFE</span><h3>Leave room to readjust.</h3><p>Daily planning can support engagement and performance, while anticipating interruptions helps when the day changes. Keep a little buffer instead of filling every minute.</p><a href="https://pubmed.ncbi.nlm.nih.gov/29154579/" target="_blank" rel="noopener">Parke et al., Journal of Applied Psychology ↗</a></article></div>`;}
  function savingCard() {
