...
(async()=>{
 ...
 try{
  ...
  await page.locator('[data-settings-section=guide]').click();await page.locator('[data-action=tour]').click();await page.locator('[data-action=tour-skip]').click();
  ...
  await page.locator('[data-page=settings]:visible').click();await page.locator('[data-settings-section=data]').click();assert((await page.locator('#bd-save-time').textContent()).includes('Last confirmed'));
